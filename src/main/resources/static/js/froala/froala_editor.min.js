...
!function (e, t) {
    ...
    V.RegisterPlugins = function (e) {
        ...
        return {
            ...
            }, isElement: r, contents: s, isVoid: function v(e) {
        ...
        function L(e) {
            ...
            !function c(a) {
                ...
                if (f.opts.htmlAllowComments || a.nodeType !== Node.COMMENT_NODE) if (a.tagName && a.tagName.match(p)) "STYLE" == a.tagName && f.helpers.isMac() && function () {
                    var e, n = a.innerHTML.trim(), r = [], t = /{([^}]+)}/g;
    ...
    V.LinkRegExCommon = "[".concat("a-z\\u0080-\\u009f\\u00a1-\\uffff0-9-_\\.", "]{1,}"), V.LinkRegExEnd = "((:[0-9]{1,5})|)(((\\/|\\?|#)[a-z\\u00a1-\\uffff0-9@?\\|!^=%&amp;\\/~+#-\\'*-_{}]*)|())", V.LinkRegExTLD = "((".concat(V.LinkRegExCommon, ")(\\.(com|net|org|edu|mil|gov|co|biz|info|me|dev)))"), V.LinkRegExHTTP = "((ftp|http|https):\\/\\/".concat(V.LinkRegExCommon, ")"), V.LinkRegExAuth = "((ftp|http|https):\\/\\/[\\u0021-\\uffff]{1,}@".concat(V.LinkRegExCommon, ")"), V.LinkRegExWWW = "(www\\.".concat(V.LinkRegExCommon, "\\.[a-z0-9-]{2,24})"), V.LinkRegEx = "(".concat(V.LinkRegExTLD, "|").concat(V.LinkRegExHTTP, "|").concat(V.LinkRegExWWW, "|").concat(V.LinkRegExAuth, ")").concat(V.LinkRegExEnd), V.LinkProtocols = ["mailto", "tel", "sms", "notes", "data"], V.MAIL_REGEX = /.+@.+\..+/i, V.MODULES.helpers = function (i) {
        ...
        function c(e) {
            ...
            if (!l.core.hasFocus() && e) {
                ...
                if (l.browser.msie && l.$box && l.$box.css("position", "fixed"), l.browser.msie && l.$wp && l.$wp.css("overflow", "visible"), l.browser.msie && l.$sc && l.$sc.css("position", "fixed"), 0 == l.browser.msie && (p(), l.el.focus(), l.events.trigger("focus"), f()), l.browser.msie && l.$sc && l.$sc.css("position", ""), l.browser.msie && l.$box && l.$box.css("position", ""), l.browser.msie && l.$wp && l.$wp.css("overflow", "auto"), t !== l.$win.scrollTop() && l.$win.scrollTop(t), !l.selection.info(l.el).atStart) return !1
            }
        ...
        return {
            ...
            }, on: h, trigger: m, bindClick: function r(e, t, n) {
            ...
            }, disableBlur: p, enableBlur: f, blurActive: u, focus: c, chainTrigger: function E(e, t, n) {
                if (!l.edit.isDisabled() || n) {
                    var r, o;
                    if (0 !== e.indexOf("shared.")) r = a[e]; else {
                        if (0 < l.shared.count) return !1;
        ...
        return {
            _startEnter: function b(e) {
                var t, n = m(e), r = n.nextSibling, o = n.previousSibling, i = g.html.defaultTag();
                ...
                for (var t = m(e), n = V.MARKERS, r = "", o = e, i = !1; o !== t;) if (!(o = o.parentNode).classList.contains("fr-img-space-wrap") && !o.classList.contains("fr-img-space-wrap2")) {
                ...
                if (n) {
                    ...
                    for (var o, i = g.node.contents(t)[0]; i && !g.node.isList(i);) o = i.nextSibling, C(n).append(i), i = o;
                    for (n = t.previousSibling; i;) o = i.nextSibling, C(n).append(i), i = o;
        ...
        function p(e) {
            ...
            n = n.previousSibling;
            var r = u.opts.htmlAllowedEmptyTags, o = n.tagName && n.tagName.toLowerCase();
            if ((!u.node.isBlock(n) || n.lastChild && o && 0 <= r.indexOf(o)) && u.node.isEditable(n)) {
                ...
                if (n.nodeType === Node.TEXT_NODE) {
                    var i = n.textContent, a = i.length;
                    if (i.length && "\n" === i[i.length - 1]) return n.textContent = i.substring(0, a - 2), 0 === n.textContent.length && n.parentNode.removeChild(n), p(e);
                    if (u.opts.tabSpaces && i.length >= u.opts.tabSpaces) 0 === i.substr(i.length - u.opts.tabSpaces, i.length - 1).replace(/ /g, "").replace(new RegExp(V.UNICODE_NBSP, "g"), "").length && (a = i.length - u.opts.tabSpaces + 1);
                    n.textContent = i.substring(0, a - f(i)), u.opts.htmlUntouched && !e.nextSibling && n.textContent.length && " " === n.textContent[n.textContent.length - 1] && (n.textContent = n.textContent.substring(0, n.textContent.length - 1) + V.UNICODE_NBSP);
                    var s = i.length !== n.textContent.length;
                    if (0 === n.textContent.length) if (s && u.opts.keepFormatOnDelete) h(n).after(V.INVISIBLE_SPACE + V.MARKERS); else if (0 !== i.length && u.node.isBlock(n.parentNode)) h(n).after(V.MARKERS); else if ((2 != n.parentNode.childNodes.length || n.parentNode != e.parentNode) && 1 != n.parentNode.childNodes.length || u.node.isBlock(n.parentNode) || u.node.isElement(n.parentNode) || !u.node.isDeletable(n.parentNode)) {
                        for (; !u.node.isElement(n.parentNode) && u.node.isEmpty(n.parentNode) && V.NO_DELETE_TAGS.indexOf(n.parentNode.tagName) < 0;) {
                            var l = n;
                            n = n.parentNode, l.parentNode.removeChild(l)
                        }
                ...
                for (var c = e; !c.previousSibling;) c = c.parentNode;
                for (; c && "BR" !== c.tagName && !u.node.isBlock(c);) {
                    var d = c;
                    c = c.nextSibling, h(n).append(d)
                }
                c && "BR" === c.tagName && h(c).remove(), h(e).remove()
        ...
        function n(e) {
            ...
            if (!u.node.isBlock(n) && u.node.isEditable(n)) {
                ...
                n.nodeType === Node.TEXT_NODE ? (h(n).before(V.MARKERS), n.textContent.length && (n.textContent = n.textContent.substring(f(n.textContent, !0), n.textContent.length))) : u.node.isDeletable(n) ? (h(n).before(V.MARKERS), h(n).remove()) : !1 !== u.events.trigger("node.remove", [h(n)]) && (h(n).before(V.MARKERS), h(n).remove()), h(e).remove()
        ...
        return {
            enter: function v(e) {
                ...
                }(), u.html.fillEmptyBlocks(!0), u.opts.htmlUntouched || (u.html.cleanEmptyTags(), u.clean.lists(), u.spaces.normalizeAroundCursor()), u.selection.restore(), u.$oel[0].offsetHeight > u.o_win.innerHeight && u.o_win.scroll(0, u.$oel[0].scrollHeight)
                ...
                if (r) {
                    var o = r.textContent;
                    o && o.length && 8203 === o.charCodeAt(o.length - 1) && (1 === o.length ? h(r).remove() : r.textContent = r.textContent.substr(0, o.length - f(o)))
                }
                return i(t) ? c(t) && g(t, h(t).parents("li").first().get(0)) ? u.cursorLists._backspace(t) : e = p(t) : a(t) ? c(t) && g(t, h(t).parents("li").first().get(0)) ? u.cursorLists._backspace(t) : function l(e) {
                ...
                }(t) : e = p(t), h(t).remove(), d(), u.html.fillEmptyBlocks(!0), u.opts.htmlUntouched || (u.html.cleanEmptyTags(), u.clean.lists(), u.spaces.normalizeAroundCursor()), u.selection.restore(), e
            }, del: function r() {
                ...
                h(e).remove(), d(), u.html.fillEmptyBlocks(!0), u.opts.htmlUntouched || (u.html.cleanEmptyTags(), u.clean.lists()), u.spaces.normalizeAroundCursor(), u.selection.restore()
            }, isAtEnd: C, isAtStart: g
        }
        ...
        function m() {
            var e = N(p(n)), t = N(p("tzgatD-13eD1dtdrvmF3c1nrC-7saQcdav==")).split(".");
            try {
        ...
        var v, b, L = f.$,
            ...
            n = "MekC-11nB-8tIzpD7pewxvzC6mD-16xerg1==", S = "lC4B3A3B2B5A1C2E4G1A2==",
        ...
        function C(e, t, n) {
            if (e) {
                ...
                if (e) {
                    if (T.node.isBlock(e) && "HR" !== e.tagName) return T.node.hasClass(e.firstChild, "fr-marker") ? C(e.firstChild.nextSibling, t, n) : C(e.firstChild, t, n), !1;
                    ...
                    for (var o = e; o && !M(o).hasClass("fr-marker") && 0 === M(o).find(".fr-marker").length && "UL" !== o.tagName && "OL" !== o.tagName;) {
                        var i = o;
                        if (T.node.isBlock(o) && "HR" !== e.tagName) return C(o.firstChild, t, n), !1;
                        o = o.nextSibling, r.append(i)
                    }
                    if (o) {
                        if (M(o).find(".fr-marker").length || "UL" === o.tagName || "OL" === o.tagName) C(o.firstChild, t, n); else if (T.browser.mozilla && T.node.hasClass(o, "fr-marker")) {
                            var a, s = T.selection.blocks(), l = s.length;
                        ...
                        if (c) {
                            var d = c.nextSibling;
                            d && (T.node.isBlock(d) ? "HR" === d.tagName ? C(d.nextSibling, t, n) : C(d.firstChild, t, n) : C(d, t, n))
                        }
                    }
                    r.is(":empty") && r.remove()
                }
        ...
        function n(e, t) {
            ...
            if (void 0 === t && (t = {}), t.style && delete t.style, T.selection.isCollapsed()) {
                T.markers.insert(), T.$el.find(".fr-marker").replaceWith(f(e, t) + V.INVISIBLE_SPACE + V.MARKERS + function a(e) {
                    return "</".concat(e, ">")
                }(e)), T.selection.restore()
            } else {
                var r;
                T.selection.save(), C(T.$el.find('.fr-marker[data-type="true"]').length && T.$el.find('.fr-marker[data-type="true"]').get(0).nextSibling, e, t);
                do {
        ...
        function x(e, t, n, r) {
            if (!r) {
                var o = !1;
                if (!0 === e.data("type")) for (; T.node.isFirstSibling(e.get(0)) && !e.parent().is(T.$el) && !e.parent().is("ol") && !e.parent().is("ul");) e.parent().before(e), o = !0; else if (!1 === e.data("type")) for (; T.node.isLastSibling(e.get(0)) && !e.parent().is(T.$el) && !e.parent().is("ol") && !e.parent().is("ul");) e.parent().after(e), o = !0;
                if (o) return !0
            }
        ...
        function r(e, t) {
            ...
            !function y(e, t, n, r) {
                for (var o = T.node.contents(e.get(0)), i = 0; i < o.length; i++) {
                    var a = o[i];
                    if (a.innerHTML && 8203 == a.innerHTML.charCodeAt() && a.tagName.toLocaleLowerCase() == n && (a.outerHTML = a.innerHTML), T.node.hasClass(a, "fr-marker")) t = (t + 1) % 2; else if (t) if (0 < M(a).find(".fr-marker").length) t = y(M(a), t, n, r); else {
                ...
                return t
            }(T.$el, 0, e, t), n || (T.$el.find(".fr-marker").remove(), T.$el.find(".fr-clone").removeClass("fr-clone").addClass("fr-marker")), n && T.$el.find(".fr-marker").before(V.INVISIBLE_SPACE).after(V.INVISIBLE_SPACE), T.html.cleanEmptyTags(), T.el.normalize(), T.selection.restore();
            var l = T.win.getSelection() && T.win.getSelection().anchorNode;
            if (l) {
                var c = T.node.blockParent(l), d = !!l.textContent.replace(/\u200B/g, "").length,
                    f = T.win.getSelection().getRangeAt(0), p = f.startOffset, u = f.endOffset;
                ...
                if (l.nodeType === Node.TEXT_NODE) {
                    if (!d || !T.selection.text().length && p === u) {
                        ...
                        if (T.browser.msie) {
                            var C = T.doc.createRange();
                            T.selection.get().removeAllRanges(), C.setStart(l, g), C.setEnd(l, g), T.selection.get().addRange(C)
                        } else h.setStart(l, g), h.setEnd(l, g)
                    }
                } else {
                    var m, v, b = 0, L = M(l).contents();
                    if (T.browser.msie) {
                    ...
                    if (m.length) {
                        ...
                        h.setStart(m.get(0), E), h.setEnd(m.get(0), E)
                    }
                }
            }
        }
        ...
        function t(e, t) {
            ...
            if (T.selection.isCollapsed()) {
                ...
                if (T.node.openTagString(l.get(0)) === '<span style="'.concat(e, ": ").concat(l.css(e), ';">')) {
                    if (T.node.isEmpty(l.get(0))) s = M(T.doc.createElement("span")).attr("style", "".concat(e, ": ").concat(t, ";")).html("".concat(V.INVISIBLE_SPACE).concat(V.MARKERS)), l.replaceWith(s); else {
                        var c = {};
                ...
                if (T.selection.save(), null === t || "color" === e && 0 < T.$el.find(".fr-marker").parents("u, a").length) {
                    ...
                    for (n = 0; n < d.length; n++) if (!0 === (r = M(d[n])).data("type") || "true" === r.data("type")) for (; T.node.isFirstSibling(r.get(0)) && !r.parent().is(T.$el) && !T.node.isElement(r.parent().get(0)) && !T.node.isBlock(r.parent().get(0));) r.parent().before(r); else for (; T.node.isLastSibling(r.get(0)) && !r.parent().is(T.$el) && !T.node.isElement(r.parent().get(0)) && !T.node.isBlock(r.parent().get(0));) r.parent().after(r)
                }
                for (var f = T.$el.find('.fr-marker[data-type="true"]').get(0).nextSibling; f.firstChild;) f = f.firstChild;
                var p = {"class": "fr-unprocessed"};
                for (t && (p.style = "".concat(e, ": ").concat(t, ";")), C(f, "span", p), T.$el.find(".fr-marker + .fr-unprocessed").each(function () {
        ...
        function m(e, t, n) {
            var r, o, i, a = e.parentsUntil(T.$el, "span[style]"), s = [];
        ...
        function o(e, t) {
            void 0 === t && (t = {}), t.style && delete t.style;
            var n = T.selection.ranges(0), r = n.startContainer;
            ...
            var i = r;
            for (i && i.nodeType !== Node.ELEMENT_NODE && (i = i.parentNode); i && i.nodeType === Node.ELEMENT_NODE && i !== T.el && !A(i, N(e, t));) i = i.parentNode;
        ...
        function T() {
            if (E.$wp) {
                ...
                for (t = 0; t < n.length; t++) if (n[t].startContainer !== E.doc || E.browser.msie) {
                    var o = (e = n[t]).collapsed, i = E.markers.place(e, !0, t), a = E.markers.place(e, !1, t);
        ...
        function M() {
            ...
            for (e = 0; e < t.length; e++) {
                var r = y(t[e]).data("id"), o = t[e], i = E.doc.createRange(),
        ...
        return {
            text: s, get: L, ranges: f, clear: S, element: function l() {
                var e = L();
                try {
                    if (e.rangeCount) {
                ...
                return E.el
            }, save: T, restore: M, isCollapsed: A, isFull: function d() {
                if (A()) return !1;
                E.selection.save();
                ...
                if (function b() {
                    ...
                    if (s.length) E.$el.find(".fr-marker").remove(), s.append(V.INVISIBLE_SPACE + V.MARKERS).removeAttr("data-first"), s.attr("data-text") && s.replaceWith(s.html()); else for (E.$el.find("table").filter(function () {
                        ...
                        if (d) {
                            if (l && (!c || c !== d)) {
                                var f = E.node.blockParent(l), p = E.node.blockParent(d), u = !1, h = !1;
                                if (f && 0 <= ["UL", "OL"].indexOf(f.tagName) && (u = !(f = null)), p && 0 <= ["UL", "OL"].indexOf(p.tagName) && (h = !(p = null)), y(l).after(d), f !== p) if (null !== f || u) if (null !== p || h || 0 !== y(f).parentsUntil(E.$el, "table").length) f && p && 0 === y(f).parentsUntil(E.$el, "table").length && 0 === y(p).parentsUntil(E.$el, "table").length && !y(f).contains(p) && !y(p).contains(f) && (y(f).append(y(p).html()), y(p).remove()); else {
                ...
                var m = E.$el.find(".fr-marker").last().get(0), v = E.$el.find(".fr-marker").first().get(0);
                ...
                if (u() && o.rangeCount) {
                    ...
                    for (t = 0; t < i.length; t++) {
                        var a = i[t], s = p(a.startContainer, a.startOffset), l = p(a.endContainer, a.endOffset);
    ...
    }, Object.assign(V.DEFAULTS, {placeholderText: ""}), V.MODULES.placeholder = function (f) {
        var p = f.$;
        ...
        function i(e) {
            ...
            var l = p();
            for (l += ",".concat(V.VOID_ELEMENTS.join(",")), l += ", .fr-inner", l += ",".concat(O.opts.htmlAllowedEmptyTags.join(":not(.fr-marker),"), ":not(.fr-marker)"), t = r.length - 1; 0 <= t; t--) if (!(r[t].textContent && 0 < r[t].textContent.replace(/\u200B|\n/g, "").length || 0 < r[t].querySelectorAll(l).length)) {
        ...
        return {
            defaultTag: d, isPreformatted: s, emptyBlocks: i, emptyBlockTagsQuery: function E() {
                return "".concat(V.BLOCK_TAGS.join(":empty, "), ":empty")
            }, blockTagsQuery: p, fillEmptyBlocks: function y(e) {
                var t = i(e);
            ...
            }, cleanEmptyTags: e, cleanWhiteTags: u, cleanBlankSpaces: n, blocks: function S() {
                return O.$el.get(0).querySelectorAll(p())
            }, getDoctype: w, set: function T(e) {
                var t = O.clean.html((e || "").trim(), [], [], O.opts.fullPage), n = new RegExp("%3A//", "g"),
                    r = t.replace(n, "://");
                if (O.opts.fullPage) {
                    var o = C(r, "body") || (0 <= r.indexOf("<body") ? "" : r), i = m(r, "body"),
                        a = C(r, "head") || "<title></title>", s = m(r, "head"), l = h("<div>");
            ...
            }, syncInputs: _, get: function B(e, t) {
                ...
                if (_(), !O.opts.useClasses && !t) {
                    ...
                    for (r = 0; r < O.doc.styleSheets.length; r++) {
                        ...
                        if (c) for (var f = 0, p = c.length; f < p; f++) if (c[f].selectorText && 0 < c[f].style.cssText.length) {
                            var u = c[f].selectorText.replace(/body |\.fr-view /g, "").replace(/::/g, ":"), h = void 0;
                            try {
                ...
                if (O.node.isEmpty(O.el)) O.opts.fullPage && (n = w(O.iframe_document), n += "<html".concat(O.node.attributes(O.$html.get(0)), ">").concat(O.$html.find("head").get(0).outerHTML, "<body></body></html>")); else if (void 0 === e && (e = !1), O.opts.fullPage) {
                    ...
                    var T = O.opts.heightMin, M = O.opts.height, N = O.opts.heightMax;
            ...
            }, checkIfEmpty: o, extractNode: C, extractNodeAttrs: m, extractDoctype: v, cleanBRs: function R() {
        ...
        function s(e) {
            ...
            p = !1;
            var r = b(n) && !m(e) && !e.altKey, o = n === V.KEYCODE.BACKSPACE || n === V.KEYCODE.DELETE;
            ...
            }(); else if (n !== V.KEYCODE.BACKSPACE || m(e) || e.altKey) if (n !== V.KEYCODE.DELETE || m(e) || e.altKey || e.shiftKey) n === V.KEYCODE.SPACE ? function l(e) {
                var t = d.selection.element();
        ...
        return {
            ...
            }, ctrlKey: m, isCharacter: b, isArrow: v, forceUndo: function N() {
        ...
        function t(e) {
            ...
            if (e && e.clipboardData && e.clipboardData.getData) {
                ...
                if (N.helpers.isArray(n)) for (var r = 0; r < n.length; r++) t += "".concat(n[r], ";"); else t = n;
        ...
        function o(e, t, n) {
            ...
            if (!t) if ((l = function E(e) {
                ...
                return A || (A = O("<div>").html(e).text()), !(!t || A.replace(/\u00A0/gi, " ").replace(/\r|\n/gi, "") !== t.replace(/\u00A0/gi, " ").replace(/\r|\n/gi, "") && A.replace(/\s/g, "") !== t.replace(/\s/g, ""))
            ...
            !t || N.wordPaste && n || (0 === (e = e.replace(/^\n*/g, "").replace(/^ /g, "")).indexOf("<colgroup>") && (e = "<table>".concat(e, "</table>")), e = $(e = function y(e) {
                ...
                var t, n = null, r = N.doc.createElement("div");
                r.innerHTML = e;
                var o = r.querySelectorAll("p, div, h1, h2, h3, h4, h5, h6, pre, blockquote");
                for (t = 0; t < o.length; t++) (n = o[t]).outerHTML = "<".concat(N.html.defaultTag() || "DIV", ">").concat(n.innerHTML, "</").concat(N.html.defaultTag() || "DIV", ">");
            ...
            if ("string" == typeof d && (e = d), "" !== e) {
                ...
                var C = N.selection.element(), m = !1;
                if (C && O(C).parentsUntil(N.el, "ul, ol").length && (m = !0), m) {
                    var v = f.children;
        ...
        return {
            _init: function u() {
                N.el.addEventListener("copy", e), N.el.addEventListener("cut", e), N.el.addEventListener("paste", t, {capture: !0}), N.events.on("drop", r), N.browser.msie && N.browser.version < 11 && (N.events.on("mouseup", function (e) {
        ...
        return f.shared.exit_flag = !1, {
            ...
            }, hide: n, onHide: function N(e, t) {
                f.events.on("popups.hide.".concat(e), t)
            }, hideAll: m, setContainer: h, refresh: function A(e) {
            ...
            }, isVisible: g, setFileListHeight: o, areVisible: C, setPopupDimensions: function w(e, t) {
        ...
        return {
            ...
            }, registerToolbar: o, focusToolbarElement: l, focusToolbar: u, focusContent: h, focusPopup: function T(r) {
            ...
            }, focusEditor: L, focusPopupButton: E, focusModalButton: function N(e) {
            ...
            }, saveSelection: t, restoreSelection: function O() {
        ...
        function o(e) {
            var t = e.next(), n = g.node.hasClass(e.get(0), "fr-active"), r = C(".fr-dropdown.fr-active").not(e),
        ...
        return {
            ...
            }, build: m, buildList: function L(e, t) {
            ...
            }, bulkRefresh: n, exec: i, click: t, hideActiveDropdowns: d, addButtons: function T(e) {
                for (var t = 0; t < e.length; t++) a.push(e)
            }, getButtons: C, getPosition: function M(e) {
        ...
        function t(e) {
            var n = E(e), t = n.is(".fr-sticky-on"), r = n.data("sticky-top"), o = n.data("sticky-scheduled");
            if (void 0 === r) {
                n.data("sticky-top", 0);
            ...
            if (L.core.hasFocus() || 0 < L.$tb.findVisible("input:focus").length) {
                ...
                if (s !== r && s !== o && (clearTimeout(n.data("sticky-timeout")), n.data("sticky-scheduled", s), n.outerHeight() < a - L.$tb.parent().offset().top && n.addClass("fr-opacity-0"), n.data("sticky-timeout", setTimeout(function () {
                    ...
                    var l = L.$tb.parent(), c = l.get(0).offsetWidth - l.get(0).clientWidth;
        ...
        function n(e) {
            if (e.offsetWidth) {
                var t = E(e), n = t.outerHeight(), r = t.data("sticky-position"),
                ...
                var s = "body" === L.opts.scrollableContainer ? L.helpers.scrollTop() : i, l = t.is(".fr-sticky-on");
                ...
                var u = L.helpers.getPX(t.data("top")), h = L.helpers.getPX(t.data("bottom")),
                    g = r.top && function v() {
        ...
        function r() {
            if (L.helpers.requestAnimationFrame()(r), !1 !== L.events.trigger("position.refresh")) for (var e = 0; e < L._stickyElements.length; e++) t(L._stickyElements[e])
        }

        function a() {
            if (L._stickyElements) for (var e = 0; e < L._stickyElements.length; e++) n(L._stickyElements[e])
        }
        ...
        return {
            _init: function s() {
                !function e() {
                    L._stickyElements = [], L.helpers.isIOS() ? (r(), L.events.$on(E(L.o_win), "scroll", function () {
                        if (L.core.hasFocus()) for (var e = 0; e < L._stickyElements.length; e++) {
                            var t = E(L._stickyElements[e]), n = t.parent(), r = L.helpers.scrollTop();
                ...
                var t = o();
                e.css({top: 0, left: 0});
                var n = t.top + t.height, r = t.left + t.width / 2 - e.get(0).offsetWidth / 2 + L.helpers.scrollLeft();
        ...
        moreRich: {buttons: ["insertLink", "insertFiles", "insertImage", "insertVideo", "insertTable", "emoticons", "fontAwesome", "specialCharacters", "embedly", "insertFile", "insertHR"]},
        moreMisc: {
        ...
        function L() {
            for (var e = C.$tb.find(".fr-more-toolbar"), c = "", t = 0; t < e.length; t++) {
                ...
                d.hasClass("fr-expanded") ? function () {
                    var n = C.helpers.getPX(d.css("padding-left")), e = d.find("> .fr-command, > .fr-btn-wrap"),
                        t = v(e[0]), r = C.helpers.getPX(t.css("margin-left")),
                        o = C.helpers.getPX(t.css("margin-right")), i = C.helpers.getPX(t.css("margin-top")),
        ...
        function d() {
            C.opts.theme && C.$tb.addClass("".concat(C.opts.theme, "-theme")), 1 < C.opts.zIndex && C.$tb.css("z-index", C.opts.zIndex + 1), "auto" !== C.opts.direction && C.$tb.removeClass("fr-ltr fr-rtl").addClass("fr-".concat(C.opts.direction)), C.helpers.isMobile() ? C.$tb.addClass("fr-mobile") : C.$tb.addClass("fr-desktop"), C.opts.toolbarContainer ? (C.opts.toolbarInline && (s(), o()), C.opts.toolbarBottom ? C.$tb.addClass("fr-bottom") : C.$tb.addClass("fr-top")) : function e() {
                ...
                C.popups.areVisible().length || C.$el.focus()
        ...
        return {
            _init: function p() {
                ...
                C.opts.toolbarInline || C.opts.toolbarBottom || (C.$second_tb = v(C.doc.createElement("div")).attr("class", "second-toolbar"), C.$box.append(C.$second_tb), (!1 !== C.ul || C.opts.attribution) && C.$second_tb.prepend('')), C.opts.toolbarContainer ? (C.shared.$tb ? (C.$tb = C.shared.$tb, C.opts.toolbarInline && s()) : (C.shared.$tb = v(C.doc.createElement("DIV")), C.shared.$tb.addClass("fr-toolbar"), C.$tb = C.shared.$tb, v(C.opts.toolbarContainer).append(C.$tb), d(), C.$tb.data("instance", C)), C.opts.toolbarInline ? C.$box.addClass("fr-inline") : C.$box.addClass("fr-basic"), C.events.on("focus", function () {
    ...
    h.fn = h.prototype = {
        constructor: h, length: 0, contains: function (e) {
            ...
            for (var e = m(), t = 0; t < this.length; t++) for (var n = this[t].childNodes, r = 0; r < n.length; r++) e.push(n[r]);
            return e
        }, attr: function (e, t) {
            if ("object" === N(e)) {
            ...
            var t, n, r = 0;
            for (t = " " + e + " "; n = this[r++];) if (1 === n.nodeType && -1 < (" " + m(this).stripAndCollapse(m(this).getClass(n)) + " ").indexOf(t)) return !0;
            return !1
            ...
            var t = m();
            if ("string" != typeof e) {
                for (var n = 0; n < e.length; n++) for (var r = 0; r < this.length; r++) if (this[r] !== e[n] && m(this[r]).contains(e[n])) {
                    t.push(e[n]);
                    break
                }
                return t
            ...
            for (var e = m(), t = 0; t < this.length; t++) for (var n = this[t].children, r = 0; r < n.length; r++) e.push(n[r]);
            return e
        }, not: function (e) {
            ...
            if (t) if ("string" == typeof t) for (var n = 0; n < this.length; n++) {
                ...
                var o = this[0];
                if (o.nextSibling) if (t instanceof h) for (var i = 0; i < t.length; i++) o.nextSibling.parentNode.insertBefore(t[i], o.nextSibling); else o.nextSibling.parentNode.insertBefore(t, o.nextSibling); else m(o.parentNode).append(t)
            }
            return this
        }, clone: function (e) {
            ...
            if (e && (i += parseInt(m(t).css("marginTop")) + parseInt(m(t).css("marginBottom"))), !r) for (var a in s) t.style[a] = n[a];
            return i
            ...
            if (!r) for (var o in s) n[o] = t.style[o], t.style[o] = s[o];
            var i = t.offsetWidth;
            if (e && (i += parseInt(m(t).css("marginLeft")) + parseInt(m(t).css("marginRight"))), !r) for (var a in s) t.style[a] = n[a];
            return i
        }, width: function (e) {
            ...
            for (var t = m(), n = 0; n < this.length; n++) for (var r = this[n].parentNode; r && r != document && this._matches(r);) e ? this._matches(r, e) && t.push(r) : t.push(r), r = r.parentNode;
            return t
